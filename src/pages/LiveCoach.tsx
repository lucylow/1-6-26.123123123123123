...
export const LiveCoach: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const demoMessages = [
      { type: 'alert' as const, content: 'Round 5: OXY exposed during rotate - suggest smoke cover' },
      { type: 'insight' as const, content: 'Team economy advantage detected - force buy recommended' },
      { type: 'info' as const, content: 'Enemy AWP spotted A site - consider flash execution' },
      { type: 'alert' as const, content: 'Pattern detected: Enemy always stacks B on eco rounds' },
    ];
