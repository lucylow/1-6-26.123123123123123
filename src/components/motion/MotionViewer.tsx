...
const PlayerModel: React.FC<{ position: [number, number, number]; color: string; label: string }> = ({
  position,
  color,
  label,
}) => {
...
const AnimatedScene: React.FC<{
  ...
  const playerLabels = ['P1', 'P2', 'P3', 'P4', 'P5'];
        ...
        <div className="relative h-[400px] w-full bg-background">
          ...
          >
            <Suspense fallback={null}>
              ...
              <MapEnvironment />
              <AnimatedScene frame={currentFrame} isPlaying={isPlaying} />
